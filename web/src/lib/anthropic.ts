...
// ~40k chars ≈ 10k tokens. A 5-hour meeting is far larger, so it gets chunked.
...
/**
 * Build the cached system prompt. The agenda + analysis instructions are
 * marked with cache_control so they aren't re-billed across every map chunk
 * of a long meeting — the main token-efficiency win for multi-hour recordings.
 */
